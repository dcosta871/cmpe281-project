...
function updateBuildings(callback){
    $.get('http://http://nodeloadbalancer-1594461647.us-west-2.elb.amazonaws.com:3000/buildings', function(res, err){
        addBuildings(res);
...
function processNewBuilding() {
    ...
    if (!buildingName) {
        ...
        $.ajax({
            type: "POST",
            url: "http://http://nodeloadbalancer-1594461647.us-west-2.elb.amazonaws.com:3000/buildings",
...
function deleteCluster(event) {
    ...
    $.ajax({
        type: "DELETE",
        url: "http://http://nodeloadbalancer-1594461647.us-west-2.elb.amazonaws.com:3000/buildings/" + currentBuildingName + "/floors/" + clusterNumber,
        // The key needs to match your method's input parameter (case-sensitive).
        success: function(data){
...
function updateExistingCluster() {
    ...
    if (!clusterName) {
        ...
        $.ajax({
            type: "PUT",
            url: "http://http://nodeloadbalancer-1594461647.us-west-2.elb.amazonaws.com:3000/buildings/" + currentBuildingName + "/floors/" + floor,
            // The key needs to match your method's input parameter (case-sensitive).
...
function processNewCluster() {
    ...
    if (!clusterName) {
        ...
        $.ajax({
            type: "POST",
            url: "http://http://nodeloadbalancer-1594461647.us-west-2.elb.amazonaws.com:3000/buildings/" + currentBuildingName + "/floors",
            // The key needs to match your method's input parameter (case-sensitive).
...
function processNewNode() {
    ...
    if (!nodeName) {
     ...
     parseInt(nodeFloorNumber) > currentBuilding['floors'][clusterFloorNumber]['rooms'].length) {
        ...
        $.ajax({
            type: "POST",
            url: "http://http://nodeloadbalancer-1594461647.us-west-2.elb.amazonaws.com:3000/buildings/" + currentBuildingName + "/floors/" + clusterFloorNumber + "/rooms",
            // The key needs to match your method's input parameter (case-sensitive).
...
function updateExistingNode() {
    ...
    if (!nodeName) {
        ...
        $.ajax({
            type: "PUT",
            url: "http://http://nodeloadbalancer-1594461647.us-west-2.elb.amazonaws.com:3000/buildings/" + currentBuildingName + "/floors/" + currentFloor + "/rooms/" + currentRoom,
            // The key needs to match your method's input parameter (case-sensitive).
...
function deleteNode(event) {
    ...
    $.ajax({
        type: "DELETE",
        url: "http://http://nodeloadbalancer-1594461647.us-west-2.elb.amazonaws.com:3000/buildings/" + currentBuildingName + "/floors/" + currentFloor + "/rooms/" + nodeNumber,
        // The key needs to match your method's input parameter (case-sensitive).
        success: function(data){
            updateBuildings([setRoomTable, createFloorPlanTable]);
        },
...
function processNewSensor() {
    ...
    if (!nodeName) {
        ...
        $.ajax({
            type: "POST",
            url: "http://http://nodeloadbalancer-1594461647.us-west-2.elb.amazonaws.com:3000/buildings/" + currentBuildingName + "/floors/" + currentFloor + "/rooms/" + currentRoom + "/sensors",
            // The key needs to match your method's input parameter (case-sensitive).
...
function updateExistingSensor() {
    ...
    if (!nodeName) {
        ...
        $.ajax({
            type: "Put",
            url: "http://http://nodeloadbalancer-1594461647.us-west-2.elb.amazonaws.com:3000/buildings/" + currentBuildingName + "/floors/" + currentFloor + "/rooms/" + currentRoom + "/sensors/" + currentSensor,
            // The key needs to match your method's input parameter (case-sensitive).
...
function deleteSensor() {
    ...
    $.ajax({
        type: "DELETE",
        url: "http://http://nodeloadbalancer-1594461647.us-west-2.elb.amazonaws.com:3000/buildings/" + currentBuildingName + "/floors/" + currentFloor + "/rooms/" + currentFloor + "/sensors/" + sensorNumber,
        // The key needs to match your method's input parameter (case-sensitive).
        success: function(data){
            updateBuildings([setSensorTable]);
        },
